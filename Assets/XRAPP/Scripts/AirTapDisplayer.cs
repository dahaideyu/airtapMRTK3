...
public class AirTapDisplayer : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //        // 使用 Instantiate 方法来克隆这个对象
        //        GameObject clone = Instantiate(poGO, parent.transform);

        //        // 然后你可以给这个克隆体设置一个新的位置
        //        clone.transform.position = GetPinchPosition(findingService.LeftHand);
        //    }
        //});
        ...
        //        // 然后你可以给这个克隆体设置一个新的位置
        //        clone.transform.position = GetPinchPosition(findingService.RightHand);
        //    }
        //});
        ...
        findingService.LeftHandStatusTriggered.AddListener(t =>
        {
            ...
            if (t)
            {
                ...
                // 使用 Instantiate 方法来克隆这个对象
                GameObject clone = Instantiate(poGO, parent.transform);
                clone.transform.localPosition = rayPos;
                textMesh.text = $"Left hand position: {GetPinchPosition(findingService.LeftHand)}";
                textMesh.text +=
